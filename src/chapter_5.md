...
Познакомится с плагинами можно на странице: https://plugin.tyrano.jp/ или на https://plugin.tyrano.jp/en 
(английская версия).

Чтобы добавить плагин в TyranoBuilder, сперва его нужно загрузить с указанного выше ресурса. Затем в главном меню в
ыбираем _Project\Plugins_ (_Проект\Плагины_), после чего откроется диалоговое окно «Плагины». Далее нажимаем кнопку 
