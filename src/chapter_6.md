...
Вы можете задать в тэге _name_ имя приложения, в тэге _description_ его описание. Так же можете указать контактную 
информацию используя тэг _author_, а в тэге _content_ определить стартовую страницу приложения.
...
файл _растровой графики PNG (Portable Network Graphics)_. В результате добавляем в файл config.xml перед тэгом 
